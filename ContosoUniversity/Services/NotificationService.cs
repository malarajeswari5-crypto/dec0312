using System;
// using System.Messaging; // TODO: MSMQ functionality needs to be replaced with alternative (e.g., Azure Service Bus, RabbitMQ, or in-memory queue)
...
namespace ContosoUniversity.Services
{
    ...
    _queuePath = configuration["NotificationQueuePath"] ?? @".\Private$\ContosoUniversityNotifications";
     ...
     // TODO: Replace MSMQ with modern messaging solution
/*
       ...
       var notification = new Notification
   {
    ...
    Operation = operation.ToString(),
     ...
     IsRead = false
        ...
        // TODO: Implement modern messaging solution here
    System.Diagnostics.Debug.WriteLine($"Notification: {notification.Message}");
